...
public class ProfileServiceImpl implements ProfileService{
	 ...
	 * ctrl + space와 특정 변수명 뒤에 . 작성해서 어떤기능이 나오는지 살펴보기 
	 */
	@Override
	...
	public void uploadProfile(MultipartFile[] files, String username, String profileImageUrl) {
		...
		// 프로필을 업데이트 하기위해 받은 이미지가 없기 때문에 처음 이름은 null로 줌
		// 없음 = null = 빈 값 NaN
		...
		//UserProfile 객체생성 각 객체에 현재 작성한 값들 넣어주는 set작성
		//image = join ,
